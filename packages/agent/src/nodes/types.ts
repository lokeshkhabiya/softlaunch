...
export const GraphState = Annotation.Root({
  ...
  theme: Annotation<string | null | undefined>(),
  ...
  projectType: Annotation<
    "full-stack" | "frontend-only" | "api-only" | "update" | "fix"
  >({
...
// Shared loggers
export const log = {
  codegen: (msg: string, ...args: unknown[]) =>
    console.log(`\x1b[36m[CODEGEN]\x1b[0m ${msg}`, ...args),
  commands: (msg: string, ...args: unknown[]) =>
    console.log(`\x1b[35m[COMMANDS]\x1b[0m ${msg}`, ...args),
  writer: (file: string, msg: string, ...args: unknown[]) =>
    console.log(`\x1b[33m[WRITER ${file}]\x1b[0m ${msg}`, ...args),
  orchestrator: (msg: string, ...args: unknown[]) =>
    console.log(`\x1b[32m[ORCHESTRATOR]\x1b[0m ${msg}`, ...args),
  planner: (msg: string, ...args: unknown[]) =>
    console.log(`\x1b[95m[PLANNER]\x1b[0m ${msg}`, ...args),
  reviewer: (msg: string, ...args: unknown[]) =>
    console.log(`\x1b[91m[REVIEWER]\x1b[0m ${msg}`, ...args),
  theme: (msg: string, ...args: unknown[]) =>
    console.log(`\x1b[34m[THEME]\x1b[0m ${msg}`, ...args),
};
